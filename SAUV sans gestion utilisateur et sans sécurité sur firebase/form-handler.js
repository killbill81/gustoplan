import { doc, setDoc, addDoc, collection, getDocs } from "https://www.gstatic.com/firebasejs/10.12.2/firebase-firestore.js";
...
class RecipeFormHandler {
    ...
    addIngredientInput(ingredient = { quantity: '', name: '', unit: 'g' }, ingredientsArray) {
        ...
        nameInput.addEventListener('input', () => {
            ...
            filtered.forEach(item => {
                ...
                resultItem.addEventListener('click', () => {
                    ...
                    unitSelect.value = item.unit; // Update the select
                    resultsDiv.classList.add('hidden');
                    // Update the array
            ...
            createItem.addEventListener('click', async () => {
                ...
                const newUnit = unitSelect.value; // Get unit from select
                try {
