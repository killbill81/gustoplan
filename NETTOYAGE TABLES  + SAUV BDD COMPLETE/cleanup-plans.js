// Ce script supprime TOUS les documents de la collection 'plans'.
...
async function runCleanup() {
    console.log("--- Début du script de nettoyage de la collection 'plans' ---");
    
    // Mettez ici le nom de la collection à vider
    const collectionToClean = 'plans';
