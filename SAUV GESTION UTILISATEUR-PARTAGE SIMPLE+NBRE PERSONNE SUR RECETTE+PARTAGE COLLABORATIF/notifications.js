...
import { collection, query, where, onSnapshot, doc, getDoc, updateDoc, addDoc } from "https://www.gstatic.com/firebasejs/10.12.2/firebase-firestore.js";
    ...
    try {
        ...
        if (shareData.plan) {
            await addDoc(collection(db, "plans"), {
                ...
                sharedAt: new Date(),
                name: `Plan de ${sender.displayName} - S${shareData.week}`
            });
        }
