...
import { doc, getDoc, setDoc, collection, getDocs, addDoc, deleteDoc, query, where } from "https://www.gstatic.com/firebasejs/10.12.2/firebase-firestore.js";
...
export default function init() {
    ...
    async function loadPlanForWeek(week) {
        ...
        if (ownPlanSnap.exists()) {
            ...
            availablePlans.push({ id: `${userId}_semaine-${week}`, name: "Mon plan", menuData: {}, servingsData: {}, remarksData: {}, numPeople: 1, startDay: 'Lundi' });
        }
    ...
    async function generateShoppingListFromPlan() {
        ...
        for (const slotId in menuData) {
            ...
            const [dayIndex, mealType] = slotId.split('-');
            ...
            for (const mealInPlan of mealsInSlot) {
                ...
                mealToUse.ingredients.forEach(ingredient => {
                    ...
                    const finalQuantity = valuePerServing * numPeopleForMeal; // Use the specific people count for the meal
