...
export default function init() {
    ...
    function loadPlan(plan) {
        ...
        numPeople = plan.numPeople || 1;
        startDay = plan.startDay || 'Lundi';

        if (elements.numPeopleInput) elements.numPeopleInput.value = numPeople;
    ...
    function setupEventListeners() {
        ...
        elements.sharePlanBtn?.addEventListener('click', () => {
            const planData = { menuData, remarksData, numPeople, startDay, week: currentWeek };
