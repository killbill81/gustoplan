...
const routes = {
                    ...
                    <div class="bg-white rounded-xl shadow-md p-4 overflow-x-auto">
                        <div id="meal-plan-grid-layout" class="min-w-[1200px]">
                            ...
                            <div class="grid grid-cols-[100px_repeat(10,_minmax(0,_1fr))] gap-1 text-center mb-1">
                                ...
                                <div class="p-2 rounded-t-lg bg-amber-100 text-amber-800 font-bold col-span-5">MIDI</div>
                                <div class="p-2 rounded-t-lg bg-stone-200 text-stone-800 font-bold col-span-5">SOIR</div>
    ...
    'shared': {
        html: `
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl md:text-3xl font-bold text-gray-800">Historique des partages</h2>
        </div>

        <div id="accepted-shares-container" class="space-y-4">
